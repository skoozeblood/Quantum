...
addCommandHandler("setdirt", setVehicleGrungeCommand)
addCommandHandler("setdirtlevel", setVehicleGrungeCommand)
addCommandHandler("setvehdirtlevel", setVehicleGrungeCommand)
addCommandHandler("setdirtlevel", setVehicleGrungeCommand)
