...
donationPerks = {
			[1] = { "Toggle-able incoming private message", 																		50, 		14 },
			...
			--[28] = { "New radio station that is aired globally on all cars radio & ghettoblasters",									9999,		30},
			--[29] = { "Customized country flags typing icon",																		9999,		30},
			--[30] = { "ATM Card - Premium, can be used to make transactions with a fair amount per day. (($50,000 per 5 hours))",	200,		0},
			--[31] = { "ATM Card - Ultimate, can be used to make transactions with unlimited amount per day.",						1000,		0},
			[32] = { "Instant 15 hours played",																						250,		1},
			[33] = { "Cellphone private number",																					50,			-1},
			[34] = { "Instantly learn language",																					150,		0},
			--[35] = { "Additional serial number in whitelist",																		9999,		1},
